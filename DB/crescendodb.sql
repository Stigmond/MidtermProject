...
START TRANSACTION;
USE `crescendodb`;
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `created_at`, `first_name`, `last_name`, `body`, `avatar_url`) VALUES (1, 'admin', 'admin', 1, 'admin', NULL, 'TEX', 'CONNECTICUT', 'A DUMMY USER RECORD', 'https://commons.wikimedia.org/wiki/File:June_odd-eyed-cat_cropped.jpg');
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `created_at`, `first_name`, `last_name`, `body`, `avatar_url`) VALUES (2, 'b_e_n_d_e_r', 'bender', 1, 'commenter', NULL, 'BENDER', 'RODRIGUEZ', 'ROBOT', 'https://commons.wikimedia.org/wiki/File:Tired_20-year-old_cat.jpg');
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `created_at`, `first_name`, `last_name`, `body`, `avatar_url`) VALUES (3, 'FryDay', 'fryday', 1, 'robot', NULL, 'PHILIP', 'FRY', 'DUDE', 'https://commons.wikimedia.org/wiki/File:Cat_November_2010-1a.jpg');
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `created_at`, `first_name`, `last_name`, `body`, `avatar_url`) VALUES (4, 'BugZapper', 'bugzapper', 1, 'monkey', NULL, 'ZAPP', 'BRANNIGAN', 'DUMBER DUDE', 'https://commons.wikimedia.org/wiki/File:Cat_playing_with_a_lizard.jpg');
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `created_at`, `first_name`, `last_name`, `body`, `avatar_url`) VALUES (5, 'pr0f3ss0r', 'professor', 1, 'pirate', NULL, 'HUBERT', 'FARNSWORTH', 'PROFESSORIAL', 'https://commons.wikimedia.org/wiki/File:Cat_Sphynx._Kittens._img_11.jpg');
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `created_at`, `first_name`, `last_name`, `body`, `avatar_url`) VALUES (6, 'richerthanYOU', 'richerthanyou', 0, 'zombie', NULL, 'AMY', 'WONG', 'OF THE MARS WONGS', 'https://commons.wikimedia.org/wiki/File:Felis_catus-cat_on_snow.jpg');
