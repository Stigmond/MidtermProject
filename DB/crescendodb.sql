...
CREATE TABLE IF NOT EXISTS `blog_comment` (
  ...
  `created_at` DATETIME NULL,
  `edited` TINYINT(1) NOT NULL DEFAULT 0,
  `in_reply_id` INT NULL DEFAULT NULL,
  `creator_id` INT NOT NULL,
...
START TRANSACTION;
USE `crescendodb`;
INSERT INTO `album_comment` (`id`, `body`, `created_at`, `edited`, `creator_id`, `album_id`) VALUES (1, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.', NULL, DEFAULT, 1, 1);
INSERT INTO `album_comment` (`id`, `body`, `created_at`, `edited`, `creator_id`, `album_id`) VALUES (2, 'Nam fermentum, diam eget semper pharetra, enim enim interdum leo, sed suscipit lorem erat eu lorem.', NULL, DEFAULT, 2, 2);
INSERT INTO `album_comment` (`id`, `body`, `created_at`, `edited`, `creator_id`, `album_id`) VALUES (3, 'Cras dapibus aliquam augue sit amet posuere.', NULL, DEFAULT, 3, 2);
INSERT INTO `album_comment` (`id`, `body`, `created_at`, `edited`, `creator_id`, `album_id`) VALUES (4, 'Curabitur in commodo felis.', NULL, DEFAULT, 4, 3);
INSERT INTO `album_comment` (`id`, `body`, `created_at`, `edited`, `creator_id`, `album_id`) VALUES (5, 'Maecenas eget lacus suscipit nunc placerat pretium.', NULL, DEFAULT, 5, 3);
INSERT INTO `album_comment` (`id`, `body`, `created_at`, `edited`, `creator_id`, `album_id`) VALUES (6, 'Curabitur purus massa, rhoncus sed gravida non, tristique sed ex.', NULL, DEFAULT, 4, 3);
INSERT INTO `album_comment` (`id`, `body`, `created_at`, `edited`, `creator_id`, `album_id`) VALUES (7, 'Morbi scelerisque tortor ut dictum ullamcorper.', NULL, DEFAULT, 1, 4);
INSERT INTO `album_comment` (`id`, `body`, `created_at`, `edited`, `creator_id`, `album_id`) VALUES (8, 'Suspendisse ornare lectus ut magna ornare viverra.', NULL, DEFAULT, 3, 5);
INSERT INTO `album_comment` (`id`, `body`, `created_at`, `edited`, `creator_id`, `album_id`) VALUES (9, 'Donec gravida, nisi sit amet mattis interdum, orci neque porta lorem, eget venenatis ipsum diam at quam.', NULL, DEFAULT, 5, 7);
INSERT INTO `album_comment` (`id`, `body`, `created_at`, `edited`, `creator_id`, `album_id`) VALUES (10, 'Duis iaculis blandit ex sed euismod. Vivamus sed faucibus arcu. Suspendisse nibh magna, vestibulum quis varius ac, faucibus sit amet mi.', NULL, DEFAULT, 2, 7);
...
START TRANSACTION;
USE `crescendodb`;
INSERT INTO `thread` (`id`, `title`, `created_at`, `creator_id`) VALUES (1, 'RANDOM DISCUSSION THREAD', NULL, 1);
INSERT INTO `thread` (`id`, `title`, `created_at`, `creator_id`) VALUES (2, 'WHY DID SNAPE KILL DUMBLEDORE? (SPOILERS)', NULL, 2);
INSERT INTO `thread` (`id`, `title`, `created_at`, `creator_id`) VALUES (3, 'HAMMING ORACLE', NULL, 2);
INSERT INTO `thread` (`id`, `title`, `created_at`, `creator_id`) VALUES (4, 'DIRT FARM', NULL, 4);
INSERT INTO `thread` (`id`, `title`, `created_at`, `creator_id`) VALUES (5, 'JESUS DIES AT THE END (SPOILERS)', NULL, 6);
...
START TRANSACTION;
USE `crescendodb`;
INSERT INTO `blog_comment` (`id`, `body`, `created_at`, `edited`, `in_reply_id`, `creator_id`, `blog_id`) VALUES (1, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur est quam, sollicitudin non consectetur eu, iaculis id leo. Phasellus sed arcu nibh. Praesent sed est tortor. Morbi sodales nisi nec leo commodo, ac fringilla nisi varius. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.', NULL, DEFAULT, NULL, 1, 1);
INSERT INTO `blog_comment` (`id`, `body`, `created_at`, `edited`, `in_reply_id`, `creator_id`, `blog_id`) VALUES (2, 'Suspendisse eget orci nec diam elementum bibendum sit amet ac enim. Pellentesque at ipsum non est sagittis pretium ut eget justo. Nulla varius velit sed eros dapibus, non viverra massa viverra.', NULL, DEFAULT, NULL, 6, 2);
INSERT INTO `blog_comment` (`id`, `body`, `created_at`, `edited`, `in_reply_id`, `creator_id`, `blog_id`) VALUES (3, 'Sed pellentesque neque sit amet elit fringilla luctus nec id ante. Pellentesque tincidunt scelerisque neque id eleifend. Aenean a tincidunt massa. Aenean augue diam, volutpat eu pretium quis, condimentum id nisi. Maecenas nec erat porttitor, sollicitudin est quis, consequat ante. Suspendisse potenti. Sed facilisis leo vel interdum feugiat. Sed sollicitudin enim sed blandit fermentum. Phasellus at diam ligula. Nam elit nunc, pulvinar a sem at, ullamcorper pulvinar lacus.', NULL, DEFAULT, NULL, 5, 3);
INSERT INTO `blog_comment` (`id`, `body`, `created_at`, `edited`, `in_reply_id`, `creator_id`, `blog_id`) VALUES (4, 'Maecenas rhoncus, dolor ut ultrices lacinia, nulla lacus rhoncus nibh, sed efficitur nibh odio in erat. Nam ultrices feugiat ante, at volutpat odio hendrerit vel.', NULL, DEFAULT, NULL, 4, 4);
INSERT INTO `blog_comment` (`id`, `body`, `created_at`, `edited`, `in_reply_id`, `creator_id`, `blog_id`) VALUES (5, 'Nunc scelerisque velit ut justo feugiat, ac faucibus nisi lobortis. Sed non ipsum elit. Cras vel neque et leo mollis laoreet. Vestibulum elit tortor, elementum ut dictum ac, ultricies id ligula. Sed euismod nec lectus ut ullamcorper.', NULL, DEFAULT, NULL, 3, 5);
INSERT INTO `blog_comment` (`id`, `body`, `created_at`, `edited`, `in_reply_id`, `creator_id`, `blog_id`) VALUES (6, 'Nam quis elit eu purus tristique bibendum vel at purus. Aliquam a dui ut orci laoreet dapibus.', NULL, DEFAULT, NULL, 2, 6);
INSERT INTO `blog_comment` (`id`, `body`, `created_at`, `edited`, `in_reply_id`, `creator_id`, `blog_id`) VALUES (7, 'Ut rhoncus ligula sem. Donec ornare non mi vel interdum. Donec rhoncus dictum metus et sollicitudin. Aliquam sed orci consectetur, rhoncus massa vitae, auctor massa. Etiam vel varius nibh, nec sagittis augue. Nunc luctus dui at mattis sagittis. Fusce vitae lorem a ligula feugiat fringilla.', NULL, DEFAULT, 1, 1, 7);
INSERT INTO `blog_comment` (`id`, `body`, `created_at`, `edited`, `in_reply_id`, `creator_id`, `blog_id`) VALUES (8, 'Quisque purus leo, lacinia at neque eu, dignissim volutpat sem. Nunc dictum non lorem vitae sagittis. Nam ullamcorper venenatis felis, ac tincidunt felis pharetra non. Nullam scelerisque ligula ac ultricies pretium.', NULL, DEFAULT, NULL, 6, 8);
INSERT INTO `blog_comment` (`id`, `body`, `created_at`, `edited`, `in_reply_id`, `creator_id`, `blog_id`) VALUES (9, 'Proin bibendum eros at maximus iaculis. In vitae condimentum orci, id tincidunt orci. Sed volutpat, magna ac mattis fermentum, tortor nisl tempor mi, et dictum magna sem maximus odio. Nunc consequat mi sapien, vel elementum felis viverra ac. Nam turpis nulla, lacinia vitae dui a, viverra vestibulum enim. Donec commodo ultrices enim sit amet facilisis. Curabitur eget mauris ut ex pulvinar finibus sit amet a metus. Ut nec orci tempor diam semper blandit. Maecenas vestibulum lobortis nulla. Nullam justo tortor, volutpat at rutrum a, pharetra a erat. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. In volutpat sem quis neque volutpat dapibus. Aenean pharetra odio sed est vestibulum, ac pulvinar arcu vehicula. In ultricies nisl sed pharetra finibus.\nDonec a viverra orci. Suspendisse potenti. Aenean non lacus elit. Aenean in lobortis felis, a dapibus neque. Curabitur at elit lacus. Vestibulum commodo quis lacus non euismod. Aenean in quam nisl.', NULL, DEFAULT, NULL, 5, 9);
INSERT INTO `blog_comment` (`id`, `body`, `created_at`, `edited`, `in_reply_id`, `creator_id`, `blog_id`) VALUES (10, 'Mauris porttitor eget lacus sed pretium. Nulla porta sit amet leo ut pellentesque. Aenean porttitor elit ut arcu tempus, ac blandit lectus malesuada. Maecenas viverra et diam vitae porta. Fusce varius sed lorem nec hendrerit. Quisque vel ligula ligula. Fusce dolor ipsum, dictum at pellentesque et, fermentum varius velit.', NULL, DEFAULT, NULL, 4, 10);
INSERT INTO `blog_comment` (`id`, `body`, `created_at`, `edited`, `in_reply_id`, `creator_id`, `blog_id`) VALUES (11, 'Nulla eget diam quis lorem suscipit laoreet tempus at dui. Nam ut purus mauris. Vestibulum libero dolor, dictum ut magna id, porta posuere quam. Nullam volutpat elit velit, at ornare nunc vehicula a. Suspendisse at lacus vel dui tincidunt tempus. Aenean ornare tempor interdum. Donec consectetur auctor tempus.', NULL, DEFAULT, NULL, 3, 9);
INSERT INTO `blog_comment` (`id`, `body`, `created_at`, `edited`, `in_reply_id`, `creator_id`, `blog_id`) VALUES (12, 'Fusce vitae enim maximus, interdum mi eu, euismod libero. Duis eget porttitor mi. Ut egestas risus vitae nunc luctus, ac tincidunt magna malesuada. Pellentesque at fermentum nulla. Sed hendrerit volutpat neque non mattis. Curabitur malesuada lectus nec diam tristique, non elementum turpis bibendum. Donec bibendum ipsum sit amet diam pharetra pretium. Aliquam vulputate dictum quam, eu eleifend mi eleifend non. Maecenas sed augue ipsum. Phasellus a scelerisque odio. Cras vitae mauris sapien.', NULL, DEFAULT, NULL, 2, 8);
INSERT INTO `blog_comment` (`id`, `body`, `created_at`, `edited`, `in_reply_id`, `creator_id`, `blog_id`) VALUES (13, 'Morbi ultrices iaculis nisi, sit amet tincidunt mauris aliquet at. Nam sollicitudin libero ut sem aliquet, at venenatis leo congue. Nulla finibus fermentum magna iaculis auctor. Nunc sed varius leo. Suspendisse blandit faucibus nisl, ut consectetur velit dignissim eu. Integer a est bibendum, dictum velit vitae, aliquet mi. Proin tempor turpis vel diam convallis sollicitudin. Fusce gravida urna ac interdum hendrerit.', NULL, DEFAULT, NULL, 1, 7);
INSERT INTO `blog_comment` (`id`, `body`, `created_at`, `edited`, `in_reply_id`, `creator_id`, `blog_id`) VALUES (14, 'Duis a porttitor nisl, ac fermentum orci. Nullam in porttitor ex. Suspendisse nulla elit, convallis eu placerat in, gravida ac dui. Fusce turpis eros, vestibulum eget urna vel, efficitur bibendum ante. Aenean placerat dui quis nunc efficitur, mattis fermentum neque finibus. Curabitur consequat risus eget nunc venenatis tempus. Morbi vestibulum, ex eget aliquet dapibus, felis libero bibendum sem, id posuere enim lectus at tellus. Phasellus elementum interdum lorem, sodales gravida diam accumsan et. Aliquam porta diam justo, vel scelerisque neque dapibus eu.', NULL, DEFAULT, 2, 6, 6);
INSERT INTO `blog_comment` (`id`, `body`, `created_at`, `edited`, `in_reply_id`, `creator_id`, `blog_id`) VALUES (15, 'Pellentesque sit amet felis mauris. Sed condimentum pulvinar sapien in sodales. Praesent pretium quam convallis leo finibus, et facilisis turpis rutrum. Nulla in sapien eget quam convallis hendrerit eu sed lectus. In eget lacus ac sapien tempor posuere. Quisque suscipit hendrerit nisl, vitae ultricies diam consectetur at. Quisque tincidunt, augue nec sodales imperdiet, nisi purus commodo massa, eu ultricies leo magna at mauris.', NULL, DEFAULT, NULL, 5, 5);
INSERT INTO `blog_comment` (`id`, `body`, `created_at`, `edited`, `in_reply_id`, `creator_id`, `blog_id`) VALUES (16, 'Morbi volutpat facilisis fermentum. Quisque mattis luctus metus ut aliquet. Proin lobortis dignissim ultricies. Quisque pharetra mi metus, ac blandit nibh molestie vitae. Maecenas justo dui, scelerisque nec arcu a, aliquam mattis magna. Etiam velit erat, commodo eu augue vel, dictum consectetur orci. Nulla facilisi.', NULL, DEFAULT, NULL, 4, 4);
INSERT INTO `blog_comment` (`id`, `body`, `created_at`, `edited`, `in_reply_id`, `creator_id`, `blog_id`) VALUES (17, 'Donec vel tellus ac velit sagittis imperdiet. Sed non tellus a mi pellentesque elementum. Aliquam ultricies ultrices odio id maximus. Donec mollis lacus a purus gravida, in faucibus nisi commodo. Nulla sit amet enim cursus, auctor magna in, tristique arcu. Nulla sed elementum nisl. Sed varius ex odio, id lacinia sapien pellentesque vel. Fusce tempus in turpis nec aliquet.', NULL, DEFAULT, NULL, 3, 3);
INSERT INTO `blog_comment` (`id`, `body`, `created_at`, `edited`, `in_reply_id`, `creator_id`, `blog_id`) VALUES (18, 'Proin nec augue porta, sodales nibh eget, egestas mauris. Aliquam hendrerit pharetra leo, ut consectetur diam lobortis id. Suspendisse eget felis lectus. Etiam in neque diam. Aliquam viverra ac ligula vitae finibus. Vestibulum at nisl at sapien suscipit tempor ut a elit. Sed congue bibendum augue. Vivamus neque velit, dignissim a leo et, ornare condimentum erat. Nunc feugiat lacinia neque, id pharetra ante elementum non. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nunc semper porta nisl, vel sollicitudin lorem cursus sit amet. Cras nec est id tortor varius placerat nec eget eros.', NULL, DEFAULT, NULL, 2, 2);
INSERT INTO `blog_comment` (`id`, `body`, `created_at`, `edited`, `in_reply_id`, `creator_id`, `blog_id`) VALUES (19, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin tempor viverra condimentum. Sed sed elementum orci. Pellentesque sed dignissim augue. Mauris leo ligula, consequat eu leo gravida, viverra tempor turpis. Etiam lacinia suscipit leo, non suscipit nibh varius sagittis. Duis euismod lacinia posuere. Pellentesque commodo et metus iaculis porta. Donec sit amet blandit augue, eu finibus ante.', NULL, DEFAULT, NULL, 1, 1);
INSERT INTO `blog_comment` (`id`, `body`, `created_at`, `edited`, `in_reply_id`, `creator_id`, `blog_id`) VALUES (20, 'Cras vulputate ipsum nec semper condimentum. Curabitur suscipit purus ut leo volutpat, congue aliquam nulla dapibus. Mauris id turpis sapien. Duis maximus lacus id erat tempus aliquam. Cras laoreet sed libero quis fermentum. Nulla sit amet rutrum diam, sit amet egestas ipsum. Integer auctor eros vel magna varius, sed consequat elit pharetra. Duis in est fringilla, placerat est eget, sagittis nulla. Fusce eget fringilla tellus, quis facilisis est.', NULL, DEFAULT, NULL, 6, 2);
INSERT INTO `blog_comment` (`id`, `body`, `created_at`, `edited`, `in_reply_id`, `creator_id`, `blog_id`) VALUES (21, 'Nulla facilisi. Nulla facilisi. In orci ipsum, vestibulum id nisl id, sollicitudin mollis metus. Mauris ut nisl in lacus venenatis vestibulum. Quisque viverra placerat volutpat. Integer laoreet vehicula lorem non rutrum. Nam nec vehicula lacus. Praesent non lobortis nibh. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Donec vitae sodales metus. Pellentesque feugiat lacus ullamcorper interdum congue. Nam iaculis mauris id sem rutrum accumsan.\nNam porta volutpat tincidunt. Nulla feugiat eget dui in viverra. Integer rhoncus aliquam convallis. Maecenas mattis risus a velit molestie, a posuere ipsum egestas. Etiam justo turpis, efficitur non tristique vel, aliquam vitae est. Sed dapibus elit mauris, vel maximus ligula tempus vitae. Suspendisse vel erat eu odio facilisis maximus non ut mi. Morbi commodo elit ullamcorper lacus varius semper. Etiam fringilla libero non est vulputate, a ultricies tellus malesuada. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus sodales odio non metus lacinia, eu ullamcorper lorem semper.\n', NULL, DEFAULT, 3, 5, 3);
INSERT INTO `blog_comment` (`id`, `body`, `created_at`, `edited`, `in_reply_id`, `creator_id`, `blog_id`) VALUES (22, 'Vestibulum tincidunt facilisis mauris. Suspendisse elementum pellentesque massa, vel consequat turpis ullamcorper quis. Donec lacus nunc, pellentesque quis ultricies at, egestas at justo. Nunc magna nulla, venenatis a nunc sed, scelerisque lacinia nibh. Morbi et condimentum justo. Fusce vitae faucibus enim. Nunc sit amet turpis sit amet purus porttitor molestie quis ac est. Nulla sodales molestie semper. Ut facilisis magna at neque ornare scelerisque. Donec vel sollicitudin sapien, eget mattis purus. Donec quis porttitor erat.\n', NULL, DEFAULT, NULL, 4, 4);
INSERT INTO `blog_comment` (`id`, `body`, `created_at`, `edited`, `in_reply_id`, `creator_id`, `blog_id`) VALUES (23, 'Nullam eget dolor eu tellus faucibus condimentum id vitae justo. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. In gravida dapibus risus. Nam convallis metus vitae nulla finibus interdum. Mauris tristique id est et consequat. Nam nec massa placerat, hendrerit ligula pretium, consectetur dui. Quisque vitae neque lectus. Cras imperdiet sollicitudin odio tempus rhoncus. Fusce iaculis neque non faucibus placerat. Pellentesque at urna a quam rutrum suscipit.\nDonec in rutrum lectus. Curabitur ut blandit massa. Nam commodo maximus augue in condimentum. Fusce cursus quis lacus at fringilla. Nullam ex orci, egestas ut mollis eu, auctor vitae erat. Cras pellentesque, est sed ullamcorper rutrum, dolor ex euismod velit, ut viverra magna sem et ex. Mauris sodales justo porttitor odio egestas, ornare ultrices sapien dictum. Morbi bibendum ut leo at congue. Etiam gravida convallis hendrerit. Donec accumsan vel metus ac lobortis. Fusce pulvinar metus faucibus nisl posuere, quis condimentum sem vestibulum.', NULL, DEFAULT, NULL, 3, 5);
INSERT INTO `blog_comment` (`id`, `body`, `created_at`, `edited`, `in_reply_id`, `creator_id`, `blog_id`) VALUES (24, 'Duis dapibus tincidunt metus. Duis eget arcu aliquet, feugiat magna in, ornare nunc. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Proin et imperdiet magna, pulvinar egestas lectus. Praesent dolor lectus, convallis quis libero eu, tempus facilisis enim. Vestibulum nec nunc justo. Cras ac tincidunt nisi. Sed blandit mauris nec tellus hendrerit congue. Suspendisse interdum mattis tempor. Aliquam erat volutpat. Curabitur gravida tincidunt est. Proin lacinia nibh nibh, a posuere neque lacinia in. Suspendisse id fringilla nibh, in varius sem. Fusce sollicitudin urna magna, non facilisis quam tempus eget. Cras id odio blandit, cursus metus ac, cursus sem.', NULL, DEFAULT, NULL, 2, 6);
INSERT INTO `blog_comment` (`id`, `body`, `created_at`, `edited`, `in_reply_id`, `creator_id`, `blog_id`) VALUES (25, 'Donec maximus, nisi non porttitor dapibus, dui purus posuere tellus, ac tincidunt erat lorem sed nisi. Aliquam molestie nulla felis, sed feugiat orci ultricies non. In eleifend augue libero, aliquet egestas magna auctor a. Ut sollicitudin ex eu tristique molestie. Aenean convallis elit at mauris elementum, a varius risus feugiat. Donec tincidunt hendrerit convallis. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Maecenas rutrum risus diam, ut fermentum nulla tincidunt a. Nam et enim enim.', NULL, DEFAULT, NULL, 1, 7);
INSERT INTO `blog_comment` (`id`, `body`, `created_at`, `edited`, `in_reply_id`, `creator_id`, `blog_id`) VALUES (26, 'Nam sapien justo, semper eu ipsum sit amet, suscipit accumsan arcu. Proin interdum interdum felis bibendum ultricies. Integer in dolor tempor nibh ornare dapibus id non justo. Etiam ut porta lorem, a imperdiet est. Sed convallis sed mi vel vestibulum. Ut condimentum efficitur justo ac tincidunt. Cras et ante eu enim semper tristique ac eu dui. Aliquam ultrices viverra orci a imperdiet.', NULL, DEFAULT, NULL, 6, 8);
INSERT INTO `blog_comment` (`id`, `body`, `created_at`, `edited`, `in_reply_id`, `creator_id`, `blog_id`) VALUES (27, 'Quisque quam ipsum, fermentum sed sagittis et, luctus id urna. Maecenas semper quam vel aliquet porta. Fusce pretium, urna ac tincidunt consectetur, ante magna semper enim, ut dictum eros libero vestibulum nulla.', NULL, DEFAULT, NULL, 5, 9);
INSERT INTO `blog_comment` (`id`, `body`, `created_at`, `edited`, `in_reply_id`, `creator_id`, `blog_id`) VALUES (28, 'Vivamus gravida scelerisque tortor, et ornare lectus feugiat non. Nunc efficitur fermentum est eu malesuada. Sed ultrices faucibus sapien.', NULL, DEFAULT, 4, 4, 10);
INSERT INTO `blog_comment` (`id`, `body`, `created_at`, `edited`, `in_reply_id`, `creator_id`, `blog_id`) VALUES (29, 'Quisque in turpis porttitor, finibus est egestas, lacinia leo. Praesent hendrerit justo massa, ut dapibus enim convallis vitae. Ut ut ex a nulla tincidunt consequat. Morbi et quam mollis, porta libero id, venenatis sem.', NULL, DEFAULT, NULL, 3, 9);
INSERT INTO `blog_comment` (`id`, `body`, `created_at`, `edited`, `in_reply_id`, `creator_id`, `blog_id`) VALUES (30, 'Duis quis suscipit ipsum. Morbi vestibulum ex vitae nibh finibus commodo. Curabitur eu orci sit amet neque consectetur imperdiet. Nullam vehicula lacinia augue in vulputate. Fusce suscipit, nulla eget lobortis viverra, ante mi vulputate odio, vitae tristique quam lorem ut libero. Etiam bibendum dui id enim aliquam condimentum. Fusce augue orci, euismod eget mauris ac, aliquet euismod eros. Ut rutrum enim elit, sit amet laoreet lacus auctor ac.', NULL, DEFAULT, NULL, 2, 8);
INSERT INTO `blog_comment` (`id`, `body`, `created_at`, `edited`, `in_reply_id`, `creator_id`, `blog_id`) VALUES (31, 'Sed sollicitudin eros at quam euismod, sit amet dictum mi egestas. Pellentesque eu orci placerat, ornare purus sit amet, ultrices mauris. Praesent orci tellus, ullamcorper et est eget, sodales malesuada metus. Sed consectetur erat dui, id maximus quam ornare vel. Curabitur consectetur sapien et ipsum aliquet, quis dignissim ligula interdum. In interdum lectus ut aliquam semper. Sed tortor sapien, tincidunt eu ultricies eu, rutrum vitae nibh. Sed molestie lectus in ultrices pulvinar. Vestibulum feugiat feugiat laoreet. Sed libero justo, auctor quis tortor non, tristique consequat odio.', NULL, DEFAULT, NULL, 1, 7);
INSERT INTO `blog_comment` (`id`, `body`, `created_at`, `edited`, `in_reply_id`, `creator_id`, `blog_id`) VALUES (32, 'Sed quis nunc et magna congue suscipit in at nisl. Nunc magna nunc, dignissim eget tristique id, auctor non est. Maecenas vestibulum turpis sed lacus rhoncus fermentum. Vivamus congue leo tincidunt augue dapibus varius. Quisque ac consectetur nisl. Vestibulum at elementum diam, non pretium dolor. Praesent a urna ac lacus dapibus mollis.', NULL, DEFAULT, NULL, 6, 6);
INSERT INTO `blog_comment` (`id`, `body`, `created_at`, `edited`, `in_reply_id`, `creator_id`, `blog_id`) VALUES (33, 'Curabitur vulputate nisl sed nibh malesuada interdum. Fusce sem sem, tempor vitae tellus vel, lacinia congue quam. Sed quis dui a orci pellentesque ullamcorper ut id tortor. Curabitur egestas nulla ac erat gravida iaculis. Cras non augue id dolor condimentum accumsan a ac nisl. Donec porttitor sed tellus a sollicitudin. Mauris elit est, elementum a velit eget, interdum euismod ipsum.', NULL, DEFAULT, NULL, 5, 5);
INSERT INTO `blog_comment` (`id`, `body`, `created_at`, `edited`, `in_reply_id`, `creator_id`, `blog_id`) VALUES (34, 'Morbi convallis enim quis odio sollicitudin, in commodo elit scelerisque. Nam vitae lectus eu ligula luctus lacinia. Nam vel ex odio. In hac habitasse platea dictumst. Proin lobortis et risus sed egestas. Duis posuere vel massa eu luctus. Interdum et malesuada fames ac ante ipsum primis in faucibus. Phasellus imperdiet dui tristique nibh dignissim, ac porta nibh volutpat. Maecenas hendrerit tincidunt ligula consequat maximus. Nam odio dui, ultrices et justo non, hendrerit efficitur erat. Sed placerat, orci nec laoreet lobortis, arcu lacus finibus ante, ac dapibus nisi enim vel magna. Ut ex orci, aliquam at nibh ac, bibendum facilisis enim. Suspendisse ipsum libero, auctor in arcu non, sollicitudin pretium nibh. Integer vel maximus leo. Quisque interdum, sapien vel pulvinar vestibulum, velit eros venenatis ipsum, nec pharetra orci nibh vitae erat.', NULL, DEFAULT, NULL, 4, 4);
INSERT INTO `blog_comment` (`id`, `body`, `created_at`, `edited`, `in_reply_id`, `creator_id`, `blog_id`) VALUES (35, 'Maecenas aliquam nec metus at cursus. Praesent vel pulvinar dui, non mattis est. Morbi viverra viverra semper. Quisque consectetur, risus nec vulputate faucibus, tellus orci vestibulum velit, eget accumsan ante lacus at mi. Quisque sodales, nunc eu facilisis pulvinar, felis sem porttitor nulla, luctus vestibulum dui velit vitae leo. In luctus nulla quis ligula posuere placerat ac ac ante. Duis id magna nec metus porttitor ornare. Praesent varius, orci facilisis dictum rhoncus, dolor nisl aliquet risus, dictum viverra purus erat in eros.', NULL, DEFAULT, 5, 3, 3);
...
INSERT INTO `genre` (`id`, `name`) VALUES (2, 'PROGRESSIVE POST-ELECTRONIC ANTI-GRUNE');
